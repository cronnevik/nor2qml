...
import no.nnsn.seisanquakemljpa.models.sfile.v1.enums.DescriptionType;
...
public class Line3 extends Line{
    ...
    private PropertyObject commentText = new PropertyObject("Text", 2, 79, PropertyType.STRING);
