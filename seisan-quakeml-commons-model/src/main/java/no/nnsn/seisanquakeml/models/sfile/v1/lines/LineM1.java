...
public class LineM1 extends Line {
    ...
    private final PropertyObject reportingAgency =
            new PropertyObject("Reporting Agency", 46, 48, PropertyType.STRING);
    private final PropertyObject magnitude =
    ...
    private final PropertyObject magnitudeRepAgency =
            new PropertyObject("Magnitude Reporting Agency", 61, 63, PropertyType.STRING);

    private final PropertyObject methodUsed =
