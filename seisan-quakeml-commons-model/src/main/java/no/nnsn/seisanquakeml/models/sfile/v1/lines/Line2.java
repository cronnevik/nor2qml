...
public class Line2 extends Line {
    ...
    private final PropertyObject logRadiusFeltArea =
            new PropertyObject(
                    ...
                    PropertyType.DOUBLE,
                    2);
    private final PropertyObject logAreaFeltSquareOne =
            new PropertyObject(
                    ...
                    PropertyType.DOUBLE,
                    2);
    private final PropertyObject intensityBoardAreaOne =
            new PropertyObject(
                    "Intensity boardering the area number 1.",
                    62,
                    63,
                    PropertyType.INTEGER);
    private final PropertyObject logAreaFeltSquareTwo =
            new PropertyObject(
                    ...
                    PropertyType.DOUBLE,
                    2);
    private final PropertyObject intensityBoardAreaTwo =
            new PropertyObject(
    ...
    private final PropertyObject qualityRepAgency =
            new PropertyObject("Quality rank of the report", 72, 72, PropertyType.STRING);
    private final PropertyObject repAgency =
