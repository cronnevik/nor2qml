...
public class LineM2 extends Line {
    ...
    private final PropertyObject mt = new PropertyObject("MT", 2, 3, PropertyType.STRING);
    private final PropertyObject mrr = new PropertyObject("Mrr or Mzz", 4, 9, PropertyType.DOUBLE,3);
    private final PropertyObject mtt = new PropertyObject("Mtt or Mxx", 11, 16, PropertyType.DOUBLE, 3);
    private final PropertyObject mpp = new PropertyObject("Mpp or Myy", 18, 23, PropertyType.DOUBLE, 3);
    private final PropertyObject mrt = new PropertyObject("Mrt or Mzx", 25, 30, PropertyType.DOUBLE, 3);
    private final PropertyObject mrp = new PropertyObject("Mrp or Mzy", 32, 37, PropertyType.DOUBLE, 3);
    private final PropertyObject mtp = new PropertyObject("Mtp or Mxy", 39, 44, PropertyType.DOUBLE, 3);
    private final PropertyObject reportingAgency = new PropertyObject("Reporting Agency", 46, 48, PropertyType.STRING);
    private final PropertyObject mtCoordinateSystem = new PropertyObject("MT coordinate system", 49, 49, PropertyType.STRING);
    private final PropertyObject exponential = new PropertyObject("Exponental", 50, 51, PropertyType.INTEGER);
    private final PropertyObject scalarMoment =
            new PropertyObject("Scalar Moment", 53, 62, PropertyType.DOUBLEOREXPONENTIAL, 3);
    private final PropertyObject methodUsed = new PropertyObject("Method used", 71, 77, PropertyType.STRING);
    private final PropertyObject qualityOfSolution = new PropertyObject("Quality of solution", 78, 78, PropertyType.STRING);
    private final PropertyObject blankField = new PropertyObject("Blank, can be used by user", 79, 79, PropertyType.STRING);
